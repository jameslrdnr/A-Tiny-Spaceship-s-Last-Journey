...
public class PlayerScreenObject extends AbstractScreenObject {
    ...
    private final double missileShootTime = .4;
...
//used for timers
    ...
    //timer used to shoot
    private double shootTimer, missileShootTimer;
    
    //is three shot active
    private boolean threeShot;
    
    //number of power up shots and missile shots
    private int PowerUpAmmo, missileAmmo;
    ...
    private boolean shooting, shootingMissile, movingDiag;
                ...
                switch (inputMethod) {
                    case "default": {
                        ...
                        if((inputList.contains(KeyEvent.VK_UP) || inputList.contains(KeyEvent.VK_W)) && (inputList.contains(KeyEvent.VK_RIGHT) || inputList.contains(KeyEvent.VK_D))){
                            if (midIntersectPoint.getY() - radius > 0 && midIntersectPoint.getX() + radius < BrickBreakerMain.SCREENWIDTH) {
                                setDegrees(UP - 45);
                                setSpeed(speed);
                            }
                            else{
                        ...
                        if((inputList.contains(KeyEvent.VK_UP) || inputList.contains(KeyEvent.VK_W)) && (inputList.contains(KeyEvent.VK_LEFT) || inputList.contains(KeyEvent.VK_A))){
                            if (midIntersectPoint.getY() - radius > 0 && midIntersectPoint.getX() - radius > 0) {
                                setDegrees(UP + 45);
                                setSpeed(speed);
                            }
                            else{
                        ...
                        if((inputList.contains(KeyEvent.VK_DOWN) || inputList.contains(KeyEvent.VK_S)) && (inputList.contains(KeyEvent.VK_RIGHT) || inputList.contains(KeyEvent.VK_D))){
                            if (midIntersectPoint.getY() + radius < BrickBreakerMain.SCREENHEIGHT && midIntersectPoint.getX() + radius < BrickBreakerMain.SCREENWIDTH) {
                                setDegrees(DOWN + 45);
                                setSpeed(speed);
                            }
                            else{
                        ...
                        if((inputList.contains(KeyEvent.VK_DOWN) || inputList.contains(KeyEvent.VK_S)) && (inputList.contains(KeyEvent.VK_LEFT) || inputList.contains(KeyEvent.VK_A))){
                            if (midIntersectPoint.getY() + radius < BrickBreakerMain.SCREENHEIGHT && midIntersectPoint.getX() - radius > 0) {
                                setDegrees(DOWN - 45);
                                setSpeed(speed);
                            }
                            else{
    ...
    public void runLogic() {
        ...
        missileShootTimer += 1.0 / framesPerSecond;
    ...
    public double getMissileShootTimer() {
        return missileShootTimer;
    }

    public void setMissileShootTimer(double missileShootTimer) {
        this.missileShootTimer = missileShootTimer;
    }
    ...
    public boolean isShootingMissile() {
        return shootingMissile;
    }

    public void setShootingMissile(boolean shootingMissile) {
        this.shootingMissile = shootingMissile;
    }
    
    public Boolean canShoot(){
        return shootTimer >= shootTime;
}
